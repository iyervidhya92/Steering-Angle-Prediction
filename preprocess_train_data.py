...
if __name__ == "__main__":
    ...
    for i in range(1, 6):
        X_train, Y_train = make_hsv_grayscale_diff_data("data/train_round2_part" + str(i) + ".txt", num_channels)
	print "Saving X..."
	print X_train.shape
        np.save("{}/X_train_round2_vgg16_hsv_gray_diff_ch4_part{}".format(data_path, i), X_train)
	print "Saving Y.."
        np.save("{}/Y_train_round2_vgg16_hsv_gray_diff_ch4_part{}".format(data_path, i), Y_train)
